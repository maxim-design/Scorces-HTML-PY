   ...
   try:
        ...
        return """<html>
                        ...
                        <body style="background-color:Black">
                          ...
                          <h1><div id="score" style="color:White" align="center">No leaderboard to show</div></h1>
                          <div id="texbox" align="center" style="color:White; font-size:25px;">An error has occourded, check playerdata file exists. </div>
                           </br></br>
